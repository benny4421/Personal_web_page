...
# function to create a new user if the email does not already exist in the database.
...
# function to authenticate a user by matching the email and encrypted password.
